                    ...
                    <form @submit.prevent="register" @keydown="form.onKeydown($event)">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                ...
                                <small class="form-text text-muted">Upload your business logo to strengthen your brand. Your logo must be at least 128px by 128px, and should be a square. It can not be bigger than 1 megabyte.</small>
                            </div>
                        </div>
                        <!-- Website -->
                        <div class="form-group row">
