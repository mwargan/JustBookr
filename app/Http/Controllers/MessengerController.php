...
class MessengerController extends Controller
{
    public function books(Request $request, $q)
    {
        ...
        foreach ($books as $row) {
            ...
            if ($row['posts_count'] == 0) {
                $row_array['buttons'] = [['type' => 'web_url', 'url' => $urllink, 'title' => 'See the book'], ['type' => 'web_url', 'url' => $sell_link, 'title' => 'Sell your copy'], ['type' => 'element_share']];
            } else {
                $row_array['buttons'] = [['type' => 'web_url', 'url' => $urllink.'#selling', 'title' => 'Buy the book ('.$row['posts_count'].')'], ['type' => 'web_url', 'url' => $sell_link, 'title' => 'Sell your copy'], ['type' => 'element_share']];
            }
        ...
        $row_array['item_url'] = $urllink;
        $row_array['buttons'] = [['type' => 'web_url', 'url' => 'https://justbookr.com', 'title' => 'See all books'], ['type' => 'web_url', 'url' => 'https://justbookr.com', 'title' => 'Go to JustBookr'], ['type' => 'element_share']];
        array_push($det, $row_array);
        $final = [
            'messages' => [
                ['attachment' => [
                ...
                ['text' => 'Hope this helps! You can also always find more textbooks on JustBookr.com!'],
            ],
        ];
    ...
    public function universities($q)
    {
        ...
        foreach ($universities as $row) {
            ...
            $row_array['item_url'] = $urllink;
            if ($row['posts_count'] == 0) {
                $row_array['buttons'] = [['type' => 'web_url', 'url' => $urllink, 'title' => 'See the university'], ['type' => 'element_share']];
            } else {
                $row_array['buttons'] = [['type' => 'web_url', 'url' => $urllink.'#selling', 'title' => 'See university books ('.$row['posts_count'].')'], ['type' => 'element_share']];
            }
            array_push($det, $row_array);
        }
        ...
        $urllink = 'https://justbookr.com/';
        $row_array['item_url'] = $urllink;
        $row_array['buttons'] = [['type' => 'web_url', 'url' => 'https://justbookr.com', 'title' => 'See all universities'], ['type' => 'web_url', 'url' => 'https://justbookr.com', 'title' => 'Go to JustBookr'], ['type' => 'element_share']];
        array_push($det, $row_array);
        $final = [
            'messages' => [
                ['attachment' => [
    ...
    {
        $wordlist = ['or', 'and', 'the', 'of', 'for', 'in', 'a', 'to', 'an', 'that', 'our', 'in', '&', '-', ':', 'ISBN-13', 'ISBN13', 'ISBN', 'edition'];
